...
|---:|---:|---|---|---:|---:|---:|---|
| 256 | 256 | numpy | False | 3 | 0.00592653 | 11.058 | CPU/NumPy fallback; run this script on a CUDA workstation for true GPU acceleration data |
| 512 | 512 | numpy | False | 5 | 0.0200088 | 13.101 | CPU/NumPy fallback; run this script on a CUDA workstation for true GPU acceleration data |
